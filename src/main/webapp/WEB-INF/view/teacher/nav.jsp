        ...
        <div class="navbar-default sidebar" role="navigation" align="center">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="${pageContext.request.contextPath}/main.do/teacher"><i class="fa fa-book fa-fw"></i>教师面板</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/orderbook.do/staffInfo.view"><i class="fa fa-book fa-fw"></i> 个人信息</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/orderbook.do/orderbook.view"><i class="fa fa-book fa-fw"></i>教材添加</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/orderbook.do/teachedCourse.view"><i class="fa fa-book fa-fw"></i>成绩录入</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/orderbook.do/changePass_tea.view"><i class="fa fa-wrench fa-fw"></i>修改密码</a>
                    </li>
                    <li>
